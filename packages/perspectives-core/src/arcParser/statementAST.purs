...
instance showLetStep :: Show LetStep where
  show = genericShow

instance eqLetStep :: Eq LetStep where
...
instance eqLetABinding :: Eq LetABinding where
  eq = genericEq
...
instance eqAssignment :: Eq Assignment where
  eq = genericEq
...
instance prettyPrintAssignment :: PrettyPrint Assignment where
  ...
  prettyPrint' t (CreateContext { contextTypeIdentifier, roleTypeIdentifier, contextExpression }) =
    let
...
instance eqAssignmentOperator :: Eq AssignmentOperator where
  eq = genericEq
