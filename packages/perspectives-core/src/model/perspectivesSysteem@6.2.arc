...
-- PDRDEPENDENCY
domain model://perspectives.domains#System@6.2
  ...
  case SocialEnvironment
    ...
    state InitMe = (callExternal util:SystemParameter( "IsFirstInstallation" ) returns Boolean) and not exists me
      on entry
        do for SystemUser
          -- This is the only place where we create a Person filled with a PerspectivesUsers instance.
    ...
    user Me = me
      perspective on extern
        ...
        action ExportForAnotherInstallation
          letA
            text <- callExternal ser:SerialiseFor( [role model://perspectives.domains#System$SocialEnvironment$Me], context >> extern ) returns String
          in
