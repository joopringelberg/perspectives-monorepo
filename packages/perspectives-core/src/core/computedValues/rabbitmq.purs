...
prepareAMQPaccount url_ adminUserName_ adminPassword_ accountName_ accountPassword_ queueName_ _ =
  try
    ( case
        head url_,
        head adminUserName_,
...
selfRegisterWithRabbitMQ url_ accountName_ accountPassword_ queueName_ _ =
  try
    ( case
        head url_,
        head accountName_,
...
setBindingKey
  ...
  -> RoleInstance
  -> MonadPerspectivesTransaction Unit
setBindingKey url_ userName_ password_ queueName_ routingKey_ _ =
  try
    ( case
        head url_,
        head userName_,
...
setPassword
  ...
  -> AccountPassword
  -> Array RoleInstance
  -> -- NOTE: this may have to be a ContextInstance.
  MonadPerspectivesTransaction Unit
...
deleteAMQPaccount
  ...
  -> RoleInstance
  -> MonadPerspectivesTransaction Unit
deleteAMQPaccount url_ adminUserName_ adminPassword_ accountName_ _ =
  try
    ( case
        head url_,
        head adminUserName_,
...
deleteQueue_
  ...
  -> RoleInstance
  -> MonadPerspectivesTransaction Unit
deleteQueue_ url_ adminUserName_ adminPassword_ queueName_ _ =
  try
    ( case
        head url_,
        head adminUserName_,
...
setPermissionsForAMQPaccount_
  ...
  -> RoleInstance
  -> MonadPerspectivesTransaction Unit
setPermissionsForAMQPaccount_ permissionsf url_ adminUserName_ adminPassword_ accountName_ queueName_ _ =
  try
    ( case
        head url_,
        head adminUserName_,
