...
instance Show UninterpretedTransactionForPeer where
  show _ = "UninterpretedTransactionForPeer"

instance PrettyPrint UninterpretedTransactionForPeer where
  prettyPrint' t _ = t <> "UninterpretedTransactionForPeer"
